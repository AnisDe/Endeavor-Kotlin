...
class QuestionActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        nameCour= intent.getStringExtra("NAME").toString()
        ...
        if (level == 1){
            questionList = setData.getQuestionLevel1()
        }
        if (level == 2){
            questionList = setData.getQuestionLevel2()
        }
