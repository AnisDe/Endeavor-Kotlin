...
class ChatFragment : Fragment() {
    ...
    override fun onCreateView(
      ...
      //  mSharedPref  = getSharedPreferences(PREF_NAME, Context.MODE_PRIVATE);
        mSharedPref = requireContext()!!.getSharedPreferences(PREF_NAME, MODE_PRIVATE)


        post_add.setOnClickListener {
            services.AddPost(mSharedPref.getString(EMAILl,"").toString(),post_message.text.toString()).enqueue(object :Callback<User>{
