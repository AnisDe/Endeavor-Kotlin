            ...
            when(it.id){
                ...
                1 -> {
                    ...
                    val profilFragment = ProfilFragment.newInstance(
                        mSharedPref.getString(EMAILl, "").toString(),
                        mSharedPref.getString(NAME, "").toString(),
...
/*
            ...
            R.id.logoutMenu ->{
                ...
                builder.setPositiveButton("Yes"){ dialogInterface, which ->
                    ...
                    //getSharedPreferences(PREF_NAME, MODE_PRIVATE).edit().commit()
